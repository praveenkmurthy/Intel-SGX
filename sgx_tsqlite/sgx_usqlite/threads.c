...
int ocall_vdbeSorterCreateThread(
  SQLiteThread **pThread,             /* Thread will use this task object */
  void *pIn                       /* Argument passed into xTask() */
){
  return sqlite3ThreadCreate(pThread, vdbeIncrPopulateThread, pIn);
}
...
int ocall_vdbeSorterCreateThread_flushThr(
  ...
  return sqlite3ThreadCreate(pThread, vdbeSorterFlushThread, pIn);
}
...
int ocall_vdbeSorterCreateThread_PmaReader(
  ...
  return sqlite3ThreadCreate(pThread, vdbePmaReaderBgIncrInit, pIn);
}
